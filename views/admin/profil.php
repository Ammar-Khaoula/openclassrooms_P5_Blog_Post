...
<div class="card m-5" >
    <div class="card text-center p-5">   
        <div>
            <img src="../../../openclassrooms_P5_Blog_Post/public/<?=$params['admin']->getPhoto()?>" alt="logo" style= "border: 1px solid; width: 200px;" >
        </div>  
    </div>
...
<form action="/openclassrooms_P5_Blog_Post/profil" method="POST">
    <div class="row">
        ...
        <button type="submit" class="btn btn-info col-md-4">Envoyer</button>
    </div>
</form>

<div class="d-flex m-5">

    <a href="../../../openclassrooms_P5_Blog_Post/public/images/cv_khaoula.pdf">Voir Mon C.V</a>

    <a href="https://www.linkedin.com/in/khaoula-ammar/" >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16" style="width: 200px; font-size: 20px;">
